...
public class ApplicationPropertyUtils {
     ...
     * Credits (including the awesome javadoc string) : http://stackoverflow.com/a/20418809<br>
     *
        ...
        try {
            ...
            for (Enumeration<NetworkInterface> ifaces = NetworkInterface.getNetworkInterfaces(); ifaces.hasMoreElements(); ) {
                ...
                for (Enumeration<InetAddress> inetAddrs = iface.getInetAddresses(); inetAddrs.hasMoreElements(); ) {
                    ...
                    //Will have to be changed when SD migrates to IPV6 by passing a flag as argument to this function.
